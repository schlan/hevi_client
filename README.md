...
- Raspberry PI/Arm based platform: [hevi-0.1.0-arm.tar.gz](https://github.com/schlan/hevi_client/releases/download/v0.1.0/hevi-0.1.0-arm.tar.gz)
- Linux x86: [hevi-0.1.0-x86.tar.gz](https://github.com/schlan/hevi_client/releases/download/v0.1.0/hevi-0.1.0-x86.tar.gz)
